...
import { creatBrand, getBrand } from "../../../Redux/ActionCreators/BrandActionCreator"
            ...
            <div className="container my-3 admin">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-center p-2 text-light'>Create Brand
