                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-center p-2 text-light'>Brand
                            <Link to="/admin/brand/create"><i className='bi bi-plus text-light float-end'></i></Link></h5>
                                ...
                                <tbody>
                                    {data.map((item) => {
                                        return <tr key={item._id}>
                                            ...
                                            <td><Link to={`/admin/brand/update/${item._id}`} className='btn btn-primary'><i className='bi bi-pencil'></i></Link></td>
                                            <td>
